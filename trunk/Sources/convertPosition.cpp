...
void convertPosition::initReferenceEllipsoid( QVector<Ellipsoid> &v_Ellipsoid )
{
    ...
    v_Ellipsoid.append( Ellipsoid( "GRS 1967",               6378160., 0.006694605 ) ); // 9
    v_Ellipsoid.append( Ellipsoid( "GRS 1980",               6378137., 0.006694380 ) ); // 10
    ...
    v_Ellipsoid.append( Ellipsoid( "WGS-84",                 6378137., 0.006694380 ) ); // 22
}
